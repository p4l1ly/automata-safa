...
RUN \
  apt-get update && \
  DEBIAN_FRONTEND=noninteractive apt-get install -y unzip wget software-properties-common capnproto libcapnp-dev cargo && \
...
RUN \
  ...
  download p4l1ly automata-safa 756dcfd4b187db30845450465ea8d91720ba143d && \
